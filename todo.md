To-Do:
    ...
    [ ] сделать отмену при повторном нажании на кнопку "редактировать" (примерно как кнопка new - save). При нажатии на отмену - подтягивать старые значения выбранного поля, изменения не сохранять и делать все поля неактивными, кнопку возвращать в "edit"
    [ ]
